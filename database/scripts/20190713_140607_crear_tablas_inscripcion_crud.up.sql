...
CREATE TABLE evaluacion_inscripcion.requisito_programa_academico(
	...
	tipo_cupo_id integer NOT NULL , -- Ajusta el tipo y tamaño según sea necesario
    tipo_inscripcion_id integer NOT NULL, -- Ajusta el tipo y tamaño según sea necesario
	activo boolean NOT NULL,
	fecha_creacion timestamp NOT NULL DEFAULT now(),
	fecha_modificacion timestamp NOT NULL DEFAULT now(),
