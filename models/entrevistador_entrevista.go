...
func (t *EntrevistadorEntrevista) TableName() string {
	return "entrevistador_entrevista"
}

func init() {
	orm.RegisterModel(new(EntrevistadorEntrevista))
}
...
// GetEntrevistadorEntrevistaById retrieves EntrevistadorEntrevista by Id. Returns error if
// Id doesn't exist
func GetEntrevistadorEntrevistaById(id int) (v *EntrevistadorEntrevista, err error) {
	o := orm.NewOrm()
	v = &EntrevistadorEntrevista{Id: id}
...
// GetAllEntrevistadorEntrevista retrieves all EntrevistadorEntrevista matches certain condition. Returns empty list if
// no records exist
...
// UpdateEntrevistadorEntrevista updates EntrevistadorEntrevista by Id and returns error if
...
// DeleteEntrevistadorEntrevista deletes EntrevistadorEntrevista by Id and returns error if
...
func DeleteEntrevistadorEntrevista(id int) (err error) {
	...
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&EntrevistadorEntrevista{Id: id}); err == nil {
